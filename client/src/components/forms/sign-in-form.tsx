...
import { useActionState, useState } from "react"; // Add useState
...
export function SigninForm() {
  ...
  // Add state to manage input values
  ...
  // Handle form submission to prevent default reset
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                value={formData.identifier} // Controlled input
