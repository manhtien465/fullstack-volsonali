    ...
    <div>
      ...
      <main>
        ...
        <p className="description">
          Click the button below, and view the sample error on the Sentry <a target="_blank" href="https://lazyblog.sentry.io/issues/?project=4509186612396112">Issues Page</a>.
