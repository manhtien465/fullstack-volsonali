    ...
    apps: [
      {
        ...
        instances: 2, // Number of instances (use 'max' for cluster mode, but Strapi may need single instance)
        exec_mode: 'cluster', // Fork mode is typically used for Strapi (cluster mode may cause port conflicts)
