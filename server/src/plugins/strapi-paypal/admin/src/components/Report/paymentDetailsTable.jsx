...
import {ArrowUp,ArrowDown,ArrowLeft, ExclamationMarkCircle} from "@strapi/icons";
...
const PaymentDetailsTable = () => {
  ...
  const handleSortNameArrowUp = async () => {
  ...
  const handleSortNameArrowDown = async () => {
  ...
  const handleSortEmailArrowUp = async () => {
  ...
  const handleSortEmailArrowDown = async () => {
  ...
  const handleSortTxnDateArrowUp = async () => {
  ...
  const handleSortTxnDateArrowDown = async () => {
              ...
              <Tr>
                <Th>
                  ...
                  {sortAscendingName ? (
                    ...
                    <IconButton
                      onClick={handleSortNameArrowDown}
                      label="sort by Name"
                      noBorder
                      icon={<ArrowDown />}
                    />
                ...
                <Th>
                  ...
                  {sortAscendingEmail ? (
                    <IconButton
                      onClick={handleSortEmailArrowUp}
                      label="sort by Email"
                      noBorder
                      icon={<ArrowUp />}
                    />
                    ...
                    <IconButton
                      onClick={handleSortEmailArrowDown}
                      label="sort by Email"
                      noBorder
                      icon={<ArrowDown />}
                    />
                ...
                <Th>
                  ...
                  {sortAscendingTxnDate ? (
                    <IconButton
                      onClick={handleSortTxnDateArrowUp}
                    ...
                    <IconButton
                      onClick={handleSortTxnDateArrowDown}
                      label="sort by TxnDate"
                      noBorder
                      icon={<ArrowDown />}
                    />
