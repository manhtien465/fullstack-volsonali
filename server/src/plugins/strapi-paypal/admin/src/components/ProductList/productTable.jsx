...
const ProductTable = ({
  ...
  const handleSortArrowDown = () => {
    handleSortAscendingName();
  };

  const handleSortArrowUpPrice = () => {
    handleSortDescendingPrice();
  };

  const handleSortArrowDownPrice = () => {
    handleSortAscendingPrice();
  };
            ...
            <Thead>
              <Tr>
                ...
                <Th>
                  ...
                  {sortAscendingPrice ? (
                    <IconButton
                      onClick={handleSortArrowUpPrice}
                      label="sort by price"
                      noBorder
                    ...
                    <IconButton
                      onClick={handleSortArrowDownPrice}
                      label="sort by Name"
                      noBorder
